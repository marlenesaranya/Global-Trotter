...
const Header: React.FC<HeaderProps> = ({ darkMode, setDarkMode, onGoHome, onLogout }) => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <button onClick={onGoHome} className="flex items-center gap-2 group">
            <div className="w-10 h-10 bg-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-200 dark:shadow-indigo-900/20 group-hover:scale-105 transition-transform">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="p-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-all"
            ...
            <button 
              onClick={onLogout}
              className="hidden sm:flex items-center gap-2 text-slate-600 dark:text-slate-300 px-4 py-2 rounded-xl font-bold hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-600 transition-all text-xs uppercase tracking-widest"
            >
